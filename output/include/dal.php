...
class tDAL
{
	var $tblcorrespondencia_at_localhost__asignacionanalista;
	var $tblcorrespondencia_at_localhost__insumos;
	var $tblcorrespondencia_at_localhost__pac;
	var $tblcorrespondencia_at_localhost__requisiciones;
	var $tblcorrespondencia_at_localhost__tipodecompra;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "asignacionanalista", "varname" => "correspondencia_at_localhost__asignacionanalista", "altvarname" => "asignacionanalista", "connId" => "correspondencia_at_localhost", "schema" => "", "connName" => "correspondencia at localhost");
		$this->lstTables[] = array("name" => "insumos", "varname" => "correspondencia_at_localhost__insumos", "altvarname" => "insumos", "connId" => "correspondencia_at_localhost", "schema" => "", "connName" => "correspondencia at localhost");
		$this->lstTables[] = array("name" => "pac", "varname" => "correspondencia_at_localhost__pac", "altvarname" => "pac", "connId" => "correspondencia_at_localhost", "schema" => "", "connName" => "correspondencia at localhost");
		$this->lstTables[] = array("name" => "requisiciones", "varname" => "correspondencia_at_localhost__requisiciones", "altvarname" => "requisiciones", "connId" => "correspondencia_at_localhost", "schema" => "", "connName" => "correspondencia at localhost");
		$this->lstTables[] = array("name" => "tipodecompra", "varname" => "correspondencia_at_localhost__tipodecompra", "altvarname" => "tipodecompra", "connId" => "correspondencia_at_localhost", "schema" => "", "connName" => "correspondencia at localhost");
	}
