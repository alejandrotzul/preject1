...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "asignacionanalista" ] = array( "url" => "asignacionanalista", "type" => 0 );
	$projectEntitiesReverse[ "asignacionanalista" ] = "asignacionanalista";
	$projectEntities[ "insumos" ] = array( "url" => "insumos", "type" => 0 );
	$projectEntitiesReverse[ "insumos" ] = "insumos";
	$projectEntities[ "pac" ] = array( "url" => "pac", "type" => 0 );
	$projectEntitiesReverse[ "pac" ] = "pac";
	$projectEntities[ "requisiciones" ] = array( "url" => "requisiciones", "type" => 0 );
	$projectEntitiesReverse[ "requisiciones" ] = "requisiciones";
	$projectEntities[ "tipodecompra" ] = array( "url" => "tipodecompra", "type" => 0 );
	$projectEntitiesReverse[ "tipodecompra" ] = "tipodecompra";
}
