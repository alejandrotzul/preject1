...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("asignacionanalista" == $this->xml_array['tables'][0])
			$isDB = true;
		if("insumos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pac" == $this->xml_array['tables'][0])
			$isDB = true;
		if("requisiciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("tipodecompra" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
