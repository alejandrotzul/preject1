...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("asignacionanalista" == $this->chrt_array['tables'][0])
			return true;
		if("insumos" == $this->chrt_array['tables'][0])
			return true;
		if("pac" == $this->chrt_array['tables'][0])
			return true;
		if("requisiciones" == $this->chrt_array['tables'][0])
			return true;
		if("tipodecompra" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
