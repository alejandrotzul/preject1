...
class ConnectionManager
{
	...
	{
		return $this->byId( "correspondencia_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "correspondencia_at_localhost";
		$data["connName"] = "correspondencia at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;correspondencia;;1"; //currently unused
		
		$this->_connectionsIdByName["correspondencia at localhost"] = "correspondencia_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "correspondencia";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=correspondencia;OPTION=3";
		// encription set
		...
		$connectionsData["correspondencia_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["asignacionanalista"] = "correspondencia_at_localhost";
		$connectionsIds["insumos"] = "correspondencia_at_localhost";
		$connectionsIds["pac"] = "correspondencia_at_localhost";
		$connectionsIds["requisiciones"] = "correspondencia_at_localhost";
		$connectionsIds["tipodecompra"] = "correspondencia_at_localhost";
